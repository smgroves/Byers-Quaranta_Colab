...
We need to read in the t145 AnnData object and convert to Seurat. 

```{r}
SeuratDisk::Convert("../notebooks/out/processed-data/patient-biopsies/t145.h5ad", dest = "h5seurat", overwrite = TRUE)
data <- LoadH5Seurat("../notebooks/out/processed-data/patient-biopsies/t145.h5seurat")
data
```


```{r}
saveRDS(data, file = "./data/combined_Seurat_142AB.rds")
